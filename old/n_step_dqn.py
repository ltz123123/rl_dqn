...
class Agent:
    def __init__(self, env_space, action_space, n_step=3):
    ...
    def train(self):
        ...
        new_qs = rewards + (self.gamma ** self.n_step) * max_future_qs * (1 - dones)
    ...
    def get_n_step_info(self):
        ...
        # [current_state, action, reward, future_state, done]
...
def run():
    ...
    plt.xlabel("Episode")
    plt.grid(True)
    plt.savefig("nstep_duel_ddqn_per_fig.png")
    plt.show()
