...
class Agent:
    ...
    def train(self):
        (
            tree_idx_list, is_weights, current_states, future_states, rewards, actions, dones
        ...
        for tree_idx, abs_error in zip(tree_idx_list, clipped_abs_error):
            self.memory.update_priority(tree_idx, abs_error)
